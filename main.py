...
MEMBER_TELEGRAM_MAP = {
    ...
    "Umaraliyev B.":     "@bunyod_lv",
    "Abduraxmonova V.":  "@Vaziira",
    "Usmonov B.":        "@UsmanovBohodirjon",
    "Vahobov X.":        "@HumoyunVaxobov",
    "Zohidjonov J.":     "@Zoxidjonov",
    "Abdusattarov A.":   "@Alisherabdusattarov",
    "Vasidjanov R.":     "@Ravshanbek_Vasidjanov",
}
