...
# ═══════════════════════════════════════════════════════
LABEL_MAHALLIY = "Zayavka turi: Mahalliy"
LABEL_IMPORT   = "Zayavka turi: Import"
LABEL_ARALASH  = "Zayavka turi: Aralash"
...
def get_card_label(card):
    """Kartaning zayavka turini qaytaradi."""
    labels = card.get("labels", [])
    for label in labels:
        name = label.get("name", "")
        if name in [LABEL_MAHALLIY, LABEL_IMPORT, LABEL_ARALASH]:
            return name
    return None
